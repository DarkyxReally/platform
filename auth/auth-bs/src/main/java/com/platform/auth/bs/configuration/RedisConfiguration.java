...
public class RedisConfiguration {
    ...
    public RedisTemplate<Object, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
    	log.info("===========> redis配置RedisConfiguration---redisTemplate");
        ...
        // 所以要使用ParserConfig.getGlobalInstance().addAccept("com.platform.");指定序列化白名单。
    ...
    public RedisTemplate<String, Object> redisStringObjectTemplate(RedisConnectionFactory redisConnectionFactory) {
    	log.info("===========> redis配置RedisConfiguration---redisStringObjectTemplate");
