package com.platform.rabbitmq.dao.util;
...
public class MyBatisGeneratorUtil {
    ...
    public static void main(String[] args) throws FileNotFoundException{
        ...
        // F:\\workspace\\ligu-app\\service\\service-dao\\target\\classes\\builder\\generatorConfig.xml
        String parentPath = file.getParentFile().getParentFile().getParentFile().getParent();
        // F:\\workspace\\ligu-app\\service\\service-dao
